...
const manifestFilePath = join(__dirname, '../custom_components/battery_charge_calculator/manifest.json');
const constantFilePath = join(__dirname, '../custom_components/battery_charge_calculator/const.py');
