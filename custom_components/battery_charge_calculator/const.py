...
# Planning provider selection (Strategy/Factory wiring)
PLANNING_TARIFF_PROVIDER = "planning_tariff_provider"
PLANNING_BATTERY_PROVIDER = "planning_battery_provider"
PLANNING_SOLAR_PROVIDER = "planning_solar_provider"
PLANNING_AXLE_PROVIDER = "planning_axle_provider"
PLANNING_TEMPERATURE_PROVIDER = "planning_temperature_provider"

# Concrete provider ids (current implementations)
PLANNING_TARIFF_PROVIDER_OCTOPUS = "octopus"
PLANNING_BATTERY_PROVIDER_GIVENERGY_MQTT = "givenergy_mqtt"
PLANNING_SOLAR_PROVIDER_SOLCAST = "solcast"
PLANNING_AXLE_PROVIDER_AXLE_API = "axle_api"
PLANNING_TEMPERATURE_PROVIDER_HOMEASSISTANT = "homeassistant_weather"

# Select options for config flow selectors
PLANNING_TARIFF_PROVIDERS = [
    PLANNING_TARIFF_PROVIDER_OCTOPUS,
]
PLANNING_BATTERY_PROVIDERS = [
    PLANNING_BATTERY_PROVIDER_GIVENERGY_MQTT,
]
PLANNING_SOLAR_PROVIDERS = [
    PLANNING_SOLAR_PROVIDER_SOLCAST,
]
PLANNING_AXLE_PROVIDERS = [
    PLANNING_AXLE_PROVIDER_AXLE_API,
]
PLANNING_TEMPERATURE_PROVIDERS = [
    PLANNING_TEMPERATURE_PROVIDER_HOMEASSISTANT,
]

# Backward-compatible defaults
DEFAULT_PLANNING_TARIFF_PROVIDER = PLANNING_TARIFF_PROVIDER_OCTOPUS
DEFAULT_PLANNING_BATTERY_PROVIDER = PLANNING_BATTERY_PROVIDER_GIVENERGY_MQTT
DEFAULT_PLANNING_SOLAR_PROVIDER = PLANNING_SOLAR_PROVIDER_SOLCAST
DEFAULT_PLANNING_AXLE_PROVIDER = PLANNING_AXLE_PROVIDER_AXLE_API
DEFAULT_PLANNING_TEMPERATURE_PROVIDER = PLANNING_TEMPERATURE_PROVIDER_HOMEASSISTANT
...
REPLAN_REASON_AXLE_WINDOWS_CHANGED = "axle_windows_changed"
